        ...
        <aside className="w-64 lg:w-72 h-screen bg-sand-100 dark:bg-sand-800 border-r border-sand-300 dark:border-sand-700 p-5 lg:p-6 flex flex-col animate-slideIn overflow-y-auto">
            ...
            <div className="space-y-3 border-t border-sand-300 dark:border-sand-700 pt-5">
                ...
                <div className="flex gap-2">
                    <button
                        onClick={toggleTheme}
                        className="flex-1 flex items-center justify-center gap-2 px-3 py-2.5 rounded-lg bg-sand-200 dark:bg-sand-700 text-sand-700 dark:text-sand-300 hover:bg-sand-300 dark:hover:bg-sand-600 transition-all"
                    ...
                    <button
                        onClick={logout}
                        className="flex-1 flex items-center justify-center gap-2 px-3 py-2.5 rounded-lg bg-terracotta text-white hover:bg-opacity-90 transition-all"
                        title="Logout"
                    >
