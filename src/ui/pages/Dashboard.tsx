          ...
          <div className="flex items-center justify-center mb-6 lg:mb-8">
            <div className="relative w-40 h-40 lg:w-48 lg:h-48">
              {mockStayDuration.map((item, index) => {
                const total = mockStayDuration.reduce(
                  (sum, d) => sum + d.value,
                  0
                );
                const rotation = mockStayDuration
                  .slice(0, index)
            ...
            {mockStayDuration.map((item) => (
              ...
              >
                <div className="flex items-center gap-2.5 lg:gap-3">
                  <div
                    className="w-3.5 h-3.5 lg:w-4 lg:h-4 rounded flex-shrink-0"
        ...
        <div className="space-y-3 lg:space-y-4">
          {mockTodayActivity.map((activity, index) => (
            ...
            >
              ...
              <span
                className={`px-3 lg:px-4 py-1.5 lg:py-2 rounded-lg text-xs lg:text-sm font-medium whitespace-nowrap shrink-0 ${
                  activity.status === 'arriving'
